...
>> Python 3 because it is meant to be the new standard going forward and Python 2 will not be supported in the future.

### Q2. Which Python Version Installed   

How can you check the version of Python installed if you happen to be on an unfamiliar computer?

>> Open the terminal and type "python" + return
