...
>> The following dataset shows the different UPenn CCEB faculty degrees (8) and frequencies:
>> {'SCD': 6, 'PHD': 32, 'MD': 1, 'MPH': 2, 'BSED': 1, 'MS': 2, 'JD': 1, 'MA': 1}


#### Q2. Find how many different titles there are, and their frequencies:  Ex:  Assistant Professor, Professor

>> The following dataset shows the different UPenn CCEB faculty titles (3) and frequencies:
...
>> There are 4 unique domains:  {'cceb.med.upenn.edu', 'email.chop.edu', 'mail.med.upenn.edu', 'upenn.edu'}
